...
if(Request.QueryString["action"] == "sendsms")
{
	...
	dict.Add("Action", "SendBatchSms");
	dict.Add("Version", "2017-05-25");
	dict.Add("RegionId", "cn-hangzhou");
	dict.Add("PhoneNumberJson", "[\""+ Request.Form["PhoneNumberJson"] +"\"]");
	dict.Add("SignNameJson", "[\""+ Request.Form["SignNameJson"] +"\"]");
	dict.Add("TemplateCode", Request.Form["TemplateCode"]);
	dict.Add("TemplateParamJson", "[{\"code\":\"" + DateTime.Now.ToString("mmss") + "\"}]");
